...
(function(window) {
  ...
  async function registrarEventoSupabase_(client, user, operation, args, moduleCode) {
    ...
    const id = input.idUsuario || input.idSesion || input.idMaterial || input.idProveedor || input.idOficina || input.idGrupo || input.idVenta || input.idValor || input.idDetallePrecio || "";
