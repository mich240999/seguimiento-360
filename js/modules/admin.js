const ADMIN_STATE = {
  ...
  function getAdministrationModuleConfiguration(code) {
    return ADMIN_MODULE_CONFIGURATION[String(code || "").toUpperCase()] ||
  ...
  function renderAdminModules() {
    ...
    region.innerHTML = ADMIN_STATE.modules.map(function(module) {
      return '<article class="builder-card"><div class="builder-card-head">' +
        '<span class="module-card-icon"><span class="material-symbols-rounded">' + escapeHtml(module.icono || "grid_view") + "</span></span>" +
